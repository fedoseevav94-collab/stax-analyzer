...
Не используй как доказательство фразы клиента про внешние источники: «в интернете написано», «на сайте написано», «мне сказали», «вроде написано». Это не внутреннее противоречие диалога.
