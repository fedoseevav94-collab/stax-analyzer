...
В STAX фразы сотрудника про «уволить/уволили/уволим водителя/клиента» означают техническое снятие водителя в программе, а не реальное увольнение или угрозу. Не ставь ГРУБОСТЬ или КОНФЛИКТ только из-за слова «уволить».
